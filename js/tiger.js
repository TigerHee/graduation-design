var game = {
  ...
  init: function () {//生成所有背景和前景格，并加入到页面
    ...
    gp.style.width = 87 * this.CN + 12 + "px";
    gp.style.height = 87 * this.RN + 12 + "px";
...
function drawHeart(){
  ...
  //var x = parseInt(Math.random()*canvasWidth);
  //var y = parseInt(Math.random()*canvasHeight);
  context.fillStyle = "white";
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),3,2);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),1,2);
  //context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),2,1);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),2,2);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),2,3);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),1,2);
  //context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),2,1);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),2,2);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),3,2);
  ...
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),1,1);
  //context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),1,2);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),2,1);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),2,2);
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),1,1);
  ...
  context.fillRect(parseInt(Math.random()*canvasWidth),parseInt(Math.random()*canvasHeight),2,2);
  //var img = new Image();
  //img.src="imgs/wx_hdbg.png";
  //img.onload = function(){
  //  context.drawImage(img,x,y,20,18);
  //}
}
//调用画心函数
function useDrawHeart(){
  setInterval(drawHeart,500);
  setInterval(drawHeart,1000);
  setInterval(drawHeart,1500);
  setInterval(drawHeart,2000);
  setInterval(drawHeart,2500);
  setInterval(drawHeart,3000);
  setInterval(drawHeart,3500);
}
